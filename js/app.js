...
// 12
{
  var c = 1;
  var a = "1";
  var processed = c + parseInt(a);  // correct this! check js Number Object
...
// 13
{
  ...
  //processed= c.toString()+a.toString();
...
// 15
{
  var processed = '01234';  // correct this!
  isEqual(5, processed.length);
}
// 16
{
  var processed = 'abcd';  // correct this! check the string's trim function
  isEqual(4, processed.length);
}
// 17
{
  var processed = 'itclub'.toUpperCase();
...
// 23
{
  var c = ["it", "club", "schweiz", "welt"]; // correct this!
  isEqual(4, c.length);
}
// 24
{
  var c = ["ABC", "club", "schweiz"]; // correct this!
  var processed = c; // correct this! check array functions
  isEqual(c[0], "ABC");
}
// 25
{
  var c = ["ABC", "CDE", "it", "club", "schweiz"]; // correct this!
  var processed = c; // correct this! check array functions
...
// 27
{
  var c = ["Ali", "Mustafa", "Mesut", "Mehmet", "Ferdi", "Cihad"]; 
  c.push("MUSTAFA");
  var  processed = c.splice(1,1);
    processed = c.join();// correct this! check array functions
